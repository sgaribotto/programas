		...
		<div class="formularioLateral">
			...
			<div id="formulario">
				<fieldset class="formularioLateral">
					<form method="post" class="formularioLateral" action="carteles.php" id="formularioCarga" target="_blank">
						...
						<select name="dia" class="formularioLateral">
							<option value="Todas">Imprimir toda la semana</option>
