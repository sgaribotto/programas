...
<html>
	<head>
		...
		<title>Graduados por cohorte</title>
		<?php 
	...
	<body>
		...
		<div class="formularioLateral">
			<h2 class="formularioLateral">Graduados por cohorte</h2>
	...
	<script>
		$(document).ready(function() {
			...
			var actualizarTabla = function() {
				...
				$('#tablaDatos').load("fuentes/AJAX.php?act=graduadosPorCohorteCONEAU", formValues, function(data) {
