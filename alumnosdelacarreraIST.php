...
<html>
	<head>
		...
		<title>Alumnos de la carrera IST</title>
		<?php 
	...
	<body>
		...
		<div class="formularioLateral">
			<h2 class="formularioLateral">Alumnos de la carrera IST</h2>
	...
	<script>
		$(document).ready(function() {
			...
			var actualizarTabla = function() {
				...
				$('#tablaDatos').load("fuentes/AJAX.php?act=tablaAlumnosCarreraCONEAUIST", formValues, function(data) {
