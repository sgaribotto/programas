...
<html>
	<head>
		...
		<title>Alumnos de la carrera</title>
		<?php 
	...
	<body>
		...
		<div class="formularioLateral">
			<h2 class="formularioLateral">Alumnos de la carrera</h2>
	...
	<script>
		$(document).ready(function() {
			...
			var actualizarTabla = function() {
				...
				$('#tablaDatos').load("fuentes/AJAX.php?act=tablaAlumnosCarreraCONEAU", formValues, function(data) {
