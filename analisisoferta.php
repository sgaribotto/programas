				...
				<fieldset class="formularioLateral">
					<form method="post" class="formularioLateral filtros" >
						...
						<select class="formularioLateral iconPeriodo filterTrigger" name="cuatrimestre" id="cuatrimestre"/>
							<option class="formularioLateral" value="1">1</option>
							<option class="formularioLateral" value="2">2</option>
							<option class="formularioLateral" value="3">3</option>
							<option class="formularioLateral" value="4">4</option>
							<option class="formularioLateral" value="5">5</option>
							<option class="formularioLateral" value="6">6</option>
							<option class="formularioLateral" value="7">7</option>
							<option class="formularioLateral" value="8">8</option>
							<option class="formularioLateral" value="Otro">Otro</option>
	...
	<script>
		$(document).ready(function() {
			...
			var actualizarTabla = function() {
				...
				$('#tablaAceptarDesignacion').load("fuentes/AJAX.php?act=tablaAnalisisOferta", formValues, function(data) {
