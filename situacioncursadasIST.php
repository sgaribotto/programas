...
<html>
	<head>
		...
		<title>Situación Cursadas</title>
		<?php 
	...
	<body>
		...
		<div class="formularioLateral">
			<h2 class="formularioLateral">Situación Cursadas IST</h2>
	...
	<script>
		$(document).ready(function() {
			...
			var actualizarTabla = function() {
				...
				$('#tablaDatos').load("fuentes/AJAX.php?act=tablaSituacionCursadasCONEAUIST", formValues, function(data) {
