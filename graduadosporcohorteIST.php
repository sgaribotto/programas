...
<html>
	<head>
		...
		<title>Graduados por cohorte IST</title>
		<?php 
	...
	<body>
		...
		<div class="formularioLateral">
			<h2 class="formularioLateral">Graduados por cohorte IST</h2>
	...
	<script>
		$(document).ready(function() {
			...
			var actualizarTabla = function() {
				...
				$('#tablaDatos').load("fuentes/AJAX.php?act=graduadosPorCohorteCONEAUIST", formValues, function(data) {
