...
<html>
	<head>
		...
		<title>Reporte Designaciones</title>
		<?php 
	...
	<body>
		...
		<div class="formularioLateral">
			<h2 class="formularioLateral">Reporte Designaciones</h2>
			<div id="mostrarFormulario">Mostrar Formulario</div>
			<div id="formulario">
				<fieldset class="formularioLateral">
					<form method="post" class="formularioLateral" action="reportedesignacionesexcel.php" id="formularioCarga" target="_blank">
						...
						<select name="reporte" class="formularioLateral">
							...
							<option value="situacion_cuatrimestral">Situación Cuatrimestral</option>
							<option value="renovacion">Renovación anual</option>
