...
<html>
	<head>
		...
		<title>Imprimir Carátulas</title>
		<?php 
	...
	<body>
		...
		<div class="formularioLateral">
			<h2 class="formularioLateral">Carátulas</h2>
			<div id="mostrarFormulario">Mostrar Formulario</div>
			<div id="formulario">
				<fieldset class="formularioLateral">
					<form method="post" class="formularioLateral" action="caratulaslistas.php" id="formularioCarga" target="_blank">
						...
						<select name="materia" class="formularioLateral">
							<option value="Todas">Imprimir todas las materia</option>
							<?php
								require 'fuentes/conexion.php';
								
								$query = "SELECT DISTINCT conjunto, CONCAT(conjunto, ' ', nombres) AS materia
								...
								while ($row = $result->fetch_array(MYSQL_ASSOC)) {
									...
									echo "<option value='{$row['conjunto']}'>{$row['materia']}</option>";
								}
							?>
						</select>
						...
						<button type="submit" class="formularioLateral iconAgregar" id="guardarCargarOtro">Imprimir</button>
					</form>
				</fieldset>
			</div>
