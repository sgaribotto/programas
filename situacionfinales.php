...
<html>
	...
	<body>
		...
		<div class="formularioLateral">
			<h2 class="formularioLateral">Situación Finales</h2>
	...
	<script>
		$(document).ready(function() {
			...
			var actualizarTabla = function() {
				...
				$('#tablaDatos').load("fuentes/AJAX.php?act=tablaSituacionFinalesCONEAU", formValues, function(data) {
